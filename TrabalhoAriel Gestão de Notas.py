def menu():
    ...
    print("5 - Lista de aprovados")
    print("6 - Lista de reprovados")
    print("7 - Procurar pelo nome")
    print("8 - Média B1")
    print("9 - Média B2")
    print("10 - Média geral")
    print("11 - Diário geral")
    print("0 - Sair")
    ...
    while True:
        try:
            ...
            if 0 <= nota_b1 <= 10:
                ...
                print("A nota B1 deve ser entre 0 e 10. Tente novamente.")
        except ValueError:
    ...
    while True:
        try:
            ...
            if 0 <= nota_b2 <= 10:
                ...
                print("A Nota B2 deve ser entre 0 e 10. Tente novamente.")
        except ValueError:
